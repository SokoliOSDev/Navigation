...
class PhotosTableViewController : UIViewController {
    ...
    private let setStatusButton : UIButton = {
        ...
        button.addTarget(PhotosTableViewController.self, action: #selector(pressStatusButton), for: .touchUpInside)
        return button
    }()
    ...
    private let statusTextField: UITextField = {
        ...
        textField.addTarget(PhotosTableViewController.self, action: #selector(statusTextChanged), for: .editingChanged)
        return textField
    }()
