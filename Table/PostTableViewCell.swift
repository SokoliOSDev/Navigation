...
class PostTableViewCell: UITableViewCell {
    ...
    private func layout() {
        ...
        NSLayoutConstraint.activate([
            ...
            newView.heightAnchor.constraint(equalToConstant: 600),
            ...
            likesPost.leftAnchor.constraint(equalTo: contentView.safeAreaLayoutGuide.leftAnchor, constant: 8),
            
            viewsPost.topAnchor.constraint(equalTo: descriptionPost.safeAreaLayoutGuide.bottomAnchor, constant: 10),
            viewsPost.rightAnchor.constraint(equalTo: contentView.safeAreaLayoutGuide.rightAnchor, constant: -8)
